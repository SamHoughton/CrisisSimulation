...
export const SUPPLY_CHAIN_SCENARIO: Scenario =
  {
    ...
    realOutcome: "This scenario is based on the 2023 MOVEit supply chain compromise and the 2022 Capita breach, both of which placed shared-service outsourcers in the dual role of data processor and incident origin point.\n\nIn the Capita breach, over 90 client organisations — including local authorities, pension schemes, and regulated firms — were affected by a breach at their shared service provider. The ICO investigated multiple data controllers for failing to adequately oversee their processor, finding that contractual data processing agreements lacked the minimum requirements under Article 28 UK GDPR. The FCA issued separate findings regarding operational resilience failures in FCA-regulated clients that had material outsourcing relationships with Capita.\n\nThe payroll disconnection decision — whether to maintain or cut a compromised vendor mid-cycle — proved to be the highest-stakes commercial call in every comparable case. Organisations that cut the vendor without a tested fallback suffered payroll failures affecting tens of thousands of employees; those that maintained the vendor faced continued exposure and regulatory criticism for prioritising commercial continuity over data subject protection.\n\nThe consistent lesson: organisations with a documented vendor incident response procedure, including contractual notification timelines and a pre-tested failover payroll mechanism, recovered faster and faced materially lower regulatory enforcement action.",
