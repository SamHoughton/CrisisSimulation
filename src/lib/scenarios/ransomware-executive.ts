  ...
  injects: [
    ...
    },
    {
      ...
      branches: [
        ...
        { optionKey: "B", nextInjectId: "rwg-i4v", trackLabel: "You opened talks. The clock is running." },
        { optionKey: "C", nextInjectId: "rwg-i4v", trackLabel: "Negotiators engaged. The clock is running." },
