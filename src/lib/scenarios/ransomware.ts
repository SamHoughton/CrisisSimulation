...
export const RANSOMWARE_SCENARIO: Scenario = {
  ...
  realOutcome: "This scenario is a composite based on multiple real ransomware incidents against UK critical infrastructure operators between 2022–2024, incorporating elements from the ALPHV/BlackCat group's documented TTPs and the 2023 Clop and LockBit campaigns targeting UK utilities and financial services.\n\nIn comparable real incidents: organisations that paid ransom received working decryption keys approximately 65% of the time but rarely recovered all exfiltrated data; OFAC reviewed several UK firms for potential sanctions violations when payments reached groups on the Specially Designated Nationals list; the ICO issued significant fines to organisations that delayed 72-hour notification — in one case citing a 'deliberate decision to investigate quietly' before notifying as an aggravating factor; and PSR data exposure triggered parliamentary questions and Ofgem engagement in multiple incidents.\n\nThe lesson consistent across all real cases: the decision taken in the first 90 minutes — whether to contain quietly or escalate — determined the regulatory and reputational trajectory for the following 18 months.",
  ...
  injects: [
...

    {
      ...
      facilitatorNotes:
        "Rewarded narrative for strong play through the back half. The team should feel the dividend of their earlier choices landing.\n\nKey point: 'walking, not bleeding' is a deliberate framing. The crisis is not over — the parliamentary session, the ICO, and the Ofgem investigation are all live. But the company has agency over the next phase rather than being reactive.\n\nThe score-routed finale (rw-i7) follows. Prepare the team for the ending reveal.",
      delayMinutes: 0,
      timerMinutes: 0,
