...
export const BUILT_IN_TEMPLATES: Scenario[] = [
  {
    ...
    briefing:
      "You are the executive leadership team of a mid-sized financial services organisation. It is Tuesday morning and you have each just arrived at the office. You will receive a series of escalating developments. Respond as you would in a real crisis: stay in character and respond under time pressure.",
    injects: [
      {
        id: "tpl-r-i1",
        order: 0,
      ...
      },
      {
        ...
        timerMinutes: 12,
        tickerHeadline: "Financial services firm reportedly hit by $4.2M ransomware demand",
        artifact: {
      ...
      },
      {
        ...
        artifact: {
          ...
          emailSubject: "FT: Request for comment on cyber incident affecting customer data",
        },
      },
      {
        id: "tpl-r-i4",
...

  {
    ...
    injects: [
      ...
      },
      {
        ...
        body: "CloudProcess confirm: 450,000 customer records accessed, including names, emails, and browsing/purchase history. No financial data taken. Attacker had access for 7 days. CloudProcess say they have 'notified the relevant authorities' in Ireland but have not confirmed whether they have specifically notified the UK ICO.",
        timerMinutes: 10,
    ...
    injects: [
      {
        ...
        timerMinutes: 8,
        tickerHeadline: "BREAKING: FCA enforcement officials arrive at major London bank",
        ...
        facilitatorNotes:
          "The warrant relates to suspected market manipulation on the fixed income desk; a whistleblower complaint was raised 6 months ago. The CEO may not be aware of the underlying investigation.",
        delayMinutes: 0,
        isDecisionPoint: true,
        targetRoles: ["CLO", "CEO"],
    ...
    injects: [
      {
        ...
        body: "06:04: The video now has 280,000 views and is trending on X under #[YourCompany]CEO. Media outlets are running 'developing story' banners. Three FTSE 100 investors have emailed your IR team. Your CEO's personal email is being flooded. The video is forensically convincing; standard filters cannot detect it as fake.",
        ...
        decisionOptions: [
          {
            ...
            consequence: "Statement goes out in 12 minutes. Media runs with it. If the video were real, this would be catastrophic. Forensics later confirms it IS fake: credibility saved, but a narrow escape.",
          },
          {
            key: "B",
      ...
      // Convergence inject — all paths lead here
      {
        ...
        timerMinutes: 12,
        tickerHeadline: "CONFIRMED: Viral CEO video determined to be AI-generated deepfake, forensic report published",
    ...
    injects: [
      ...
      // Branch C — silent feature flag
      {
        ...
        decisionOptions: [
          {
            key: "A",
            label: "Get ahead of it: issue statement 'We acted swiftly to protect customers'",
          ...
          {
            key: "B",
            label: "Ignore the tweet and hope it doesn't go viral",
      ...
      // Convergence
      {
        ...
        body: "Saturday 09:00: Whatever path you took, the board has convened. The Finance Director has circulated a P&L impact analysis. The question on everyone's lips: was this a one-off or systemic? Your CTO has discovered that 11 other open-source libraries you depend on have similar potential vulnerabilities, none ever audited. The board is asking whether this needs to go to shareholders.",
        timerMinutes: 12,
